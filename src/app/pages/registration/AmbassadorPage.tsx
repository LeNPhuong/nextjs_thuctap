    ...
    <>
      ...
      <div className="pt-[62px] pb-[55px] px-[245px] bg-white font-v1">
        <div className="flexCol items-center">
          <Title family="font-v1" fontSize="25" fontWeight={400} marginBottom="80">
            Welcome NAME SURNAME
          </Title>
          <p className="font-md text-18 mb-[55px]">Please fill in the complete details in the form below</p>
          <UploadImage />
        </div>
        <Title fontSize="18" fontWeight={500} family="font-v1" marginTop="40" marginBottom="20">
          Personal Details
        </Title>
        <div className="w-full flexRow flex-wrap gap-y-[20px]">
          ...
          <BoxItem bg="none" width="50%" center={false}>
            <InputForm fsz={14} width={308} height={45} gap={5} label="Display Name" />
          </BoxItem>
          <BoxGender />
          <BoxItem bg="none" width="50%" center={false}>
          ...
          <BoxItem bg="none" width="50%" center={false}>
            <InputForm fsz={14} width={308} height={45} gap={5} label="Instagram" />
          </BoxItem>
          <BoxItem bg="none" width="50%" center={false}>
            <InputForm fsz={14} width={308} height={45} gap={5} label="Youtube" />
          </BoxItem>
          <BoxItem bg="none" width="50%" center={false}>
            <InputForm fsz={14} width={308} height={45} gap={5} label="Set Password" />
          </BoxItem>
          <BoxItem bg="none" width="50%" center={false}>
            <InputForm fsz={14} width={308} height={45} gap={5} label="Repeat Password" />
          </BoxItem>
        </div>
        ...
        <Btn css="text-white w-full max-w-[145px] min-h-[49px] max-h-[49px] mx-auto mt-[40px]">REGISTER</Btn>
      </div>
    </>
  );
};
